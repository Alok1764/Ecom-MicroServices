...
import org.ecom.ecommerceapplication.DTO.Request.CartItemRequest;
...
import org.ecom.ecommerceapplication.Repositories.CartItemRepo;
import org.ecom.ecommerceapplication.Repositories.ProductRepo;
...
public class CartService {
    ...
    public boolean addToCart(String userId, CartItemRequest request) {
        ...
        CartItem existingCartItem=cartItemRepo.findByUsersAndProduct(users,product);
    ...
    public boolean deleteItemFromCart(String userId, Long productId) {
        ...
        if(product!=null && users!=null){
           cartItemRepo.deleteByUsersAndProducts(users,product);
           return true;
        }
        return false;
    }
